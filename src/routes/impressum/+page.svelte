...
<div class="space-y-8 p-4 lg:p-16">
	...
	<p>
		<strong>Allgemeiner Kontakt:</strong> <br />
		E-Mail: <a href="mailto:info@cubyx.eu">info@cubyx.eu</a>
	</p>
	...
	<p>
		...
		werden wir diese Inhalte umgehend entfernen.<br /><br /><strong>Haftung für Links</strong><br />
		...
		auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder eMail-Adressen) erhoben
