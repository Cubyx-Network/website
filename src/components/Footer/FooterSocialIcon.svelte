<script lang="ts">
	...
	export let icon: BrandIconDefinition | SolidIconDefinition | RegularIconDefinition;
	export let href: string;
</script>

<a {href} target="_blank">
	<Icon data={icon} class="h-6 w-auto text-base-content text-[2em] md:h-8 lg:h-12" />
</a>
