...
const ProjectCard = ({
  ...
  return (
    <div className="group flex h-96 w-48 flex-col overflow-hidden rounded-lg bg-background-secondary shadow-xl transition-all hover:w-96 dark:bg-background-secondary-dark">
